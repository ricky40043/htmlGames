...
`;
    ...
    // === 額外 100 題 ===
    const additionalQuestionsRaw = `
geography|medium|世界上最大的島嶼是哪一個？|格陵蘭|新幾內亞|婆羅洲|馬達加斯加
geography|medium|哪一條河流流經埃及並注入地中海？|尼羅河|亞馬遜河|多瑙河|恆河
geography|hard|安地斯山脈主要位於哪個大陸？|南美洲|北美洲|亞洲|非洲
geography|medium|哪一個國家以「千島之國」著稱？|印尼|菲律賓|日本|希臘
geography|hard|博斯普魯斯海峽分隔哪兩個大洲？|歐洲與亞洲|亞洲與非洲|歐洲與非洲|北美洲與南美洲
geography|medium|撒哈拉沙漠位於哪個大洲？|非洲|亞洲|澳洲|南美洲
geography|hard|世界最深的湖泊是？|貝加爾湖|里海|蘇必利爾湖|維多利亞湖
geography|medium|哪個國家同時橫跨歐洲與亞洲？|土耳其|葡萄牙|埃及|印度
geography|hard|巴拿馬運河連接哪兩個大洋？|大西洋與太平洋|太平洋與印度洋|大西洋與北冰洋|印度洋與南冰洋
geography|medium|喜馬拉雅山脈的最高峰是哪一座？|珠穆朗瑪峰|K2|干城章嘉峰|南迦帕爾巴特峰
geography|hard|哪個國家擁有世界上最長的海岸線？|加拿大|俄羅斯|澳洲|美國
geography|medium|維蘇威火山位於哪個國家？|義大利|希臘|冰島|墨西哥
geography|hard|亞馬遜雨林主要位於哪個國家？|巴西|哥倫比亞|秘魯|玻利維亞
geography|medium|哪一座城市被稱為「永恆之城」？|羅馬|雅典|巴黎|耶路撒冷
geography|hard|哪個海域因高鹽度而讓人容易漂浮？|死海|黑海|珊瑚海|北海
geography|medium|紐西蘭的南島以哪座著名山脈為主？|南阿爾卑斯山|洛磯山脈|烏拉山脈|阿特拉斯山脈
geography|hard|世界最大的珊瑚礁系統位於哪個國家附近？|澳洲|日本|菲律賓|馬爾地夫
geography|medium|哪個國家的國土形狀常被比喻成靴子？|義大利|西班牙|希臘|克羅埃西亞
geography|hard|多瑙河最後注入哪個海？|黑海|地中海|波羅的海|北海
geography|medium|哪個城市坐落在泰晤士河畔？|倫敦|都柏林|里斯本|布魯塞爾
history|medium|古羅馬競技場主要用來舉辦什麼活動？|公共表演與角鬥|國王加冕|貿易展覽|天文觀測
history|medium|古埃及人使用哪種文字？|象形文字|楔形文字|甲骨文|腓尼基字母
history|hard|文藝復興時期的核心思想之一是什麼？|人文主義|神權至上|封建閉關|機械決定論
history|medium|古希臘奧運會最初是為了祭祀哪位神？|宙斯|阿波羅|雅典娜|波賽頓
history|hard|《羅馬帝國衰亡史》的作者是誰？|愛德華・吉朋|托克維爾|伏爾泰|但丁
history|medium|工業革命最早大規模發生在哪個國家？|英國|法國|德國|美國
history|hard|美國《權利法案》前十條修正案主要保障什麼？|公民基本權利|總統任期|州界劃分|貨幣制度
history|medium|古代絲綢之路最重要的作用之一是什麼？|促進跨地域貿易與交流|建立海底電纜|運送石油|劃分時區
history|hard|啟蒙時代的思想家孟德斯鳩提出哪項重要政治理念？|權力分立|君權神授|計畫經濟|種姓制度
history|medium|第二次世界大戰期間，日本偷襲了哪個美國海軍基地？|珍珠港|關島|檀香山港|聖地牙哥
history|hard|古巴革命後成為古巴主要領導人的是誰？|菲德爾・卡斯楚|切・格瓦拉|巴蒂斯塔|胡志明
history|medium|哪一場革命以攻陷巴士底監獄作為象徵事件？|法國大革命|俄國革命|光榮革命|工業革命
history|hard|冷戰期間的「太空競賽」主要是哪兩國之間？|美國與蘇聯|英國與法國|中國與日本|印度與巴基斯坦
history|medium|古代中國的科舉制度主要用來選拔什麼人才？|官員|工匠|商人|軍樂隊
history|hard|《物種起源》的作者是誰？|查爾斯・達爾文|艾薩克・牛頓|路易・巴斯德|格雷戈爾・孟德爾
history|medium|哪個文明使用楔形文字並興起於兩河流域？|蘇美人|印加人|維京人|毛利人
history|hard|印度獨立運動中的「食鹽進軍」由誰領導？|甘地|尼赫魯|泰戈爾|真納
history|medium|古代腓尼基人最擅長哪一項活動？|航海與貿易|馴養恐龍|火藥製造|高山採礦
history|hard|柏林圍牆主要象徵哪種政治對立？|東西方冷戰|南北戰爭|宗教改革|殖民競爭
history|medium|世界第一部成文憲法通常被認為是哪一部？|美國憲法|法國憲法|大日本帝國憲法|聯合國憲章
science|medium|光年是用來衡量什麼的單位？|距離|時間|亮度|質量
science|medium|人體中負責過濾血液並形成尿液的器官是？|腎臟|肝臟|胰臟|脾臟
science|hard|DNA 雙股螺旋結構的兩位主要發現者是？|華生與克里克|牛頓與胡克|達爾文與孟德爾|居禮夫婦
science|medium|植物蒸散作用主要透過哪個構造？|氣孔|根毛|花粉|木質部
science|hard|黑洞的事件視界代表什麼？|連光也無法逃離的邊界|黑洞的固體表面|星系的外圍|宇宙的起點
science|medium|哪一種血型通常被稱為紅血球的萬用捐血者？|O 型陰性|AB 型陽性|A 型陽性|B 型陰性
science|hard|在生態系中，分解者主要扮演什麼角色？|分解有機物並回收養分|製造陽光|捕食所有動物|固定行星軌道
science|medium|酵母菌讓麵包膨脹主要產生哪種氣體？|二氧化碳|氧氣|氮氣|氫氣
science|hard|量子力學中的「波粒二象性」描述什麼現象？|微觀粒子同時呈現波與粒子特性|光只能直線傳播|物體不能被觀測|時間停止流動
science|medium|人體吸收大部分養分的部位是？|小腸|胃|大腸|食道
science|hard|哪一種粒子不帶電？|中子|電子|質子|正電子
science|medium|地球大氣層中，最接近地面的那一層是？|對流層|平流層|中氣層|熱氣層
science|hard|超導體的重要特性之一是什麼？|電阻在特定條件下降為零|永遠不會發熱|只能傳導光|會自行產生燃料
science|medium|彩色顯示器常用哪三種光的原色混合？|紅、綠、藍|紅、黃、藍|黑、白、灰|青、洋紅、黃
science|hard|宇宙微波背景輻射通常被視為哪項理論的重要證據？|大爆炸理論|板塊構造理論|細胞學說|相對論的引力波
science|medium|哪種營養素是構成肌肉與酵素的重要材料？|蛋白質|水|膳食纖維|膽固醇
science|hard|火箭在太空中仍能前進，主要依靠哪個物理原理？|作用力與反作用力|浮力|靜電感應|毛細作用
science|medium|珊瑚礁的主要建造者是哪一類生物？|珊瑚蟲|海綿|海草|水母
science|hard|疫苗的主要作用是讓免疫系統先建立什麼？|免疫記憶|骨骼|消化酵素|血糖
science|medium|月球表面重力約為地球的多少？|六分之一|二分之一|三分之一|十分之一
science|hard|研究地震時，科學家常用哪種儀器記錄地面振動？|地震儀|氣壓計|光度計|濕度計
sports|medium|足球比賽中，越位規則主要限制哪一種進攻位置？|進攻球員提前站在防守線後方|守門員用手接球|球員在界外發球|裁判吹哨時間
sports|medium|籃球中的「大三元」通常指單場三項數據都達到多少？|10 次以上|5 次以上|15 次以上|20 次以上
sports|hard|網球四大滿貫中，唯一在草地上舉行的是哪一項？|溫布頓|法國網球公開賽|美國網球公開賽|澳洲網球公開賽
sports|medium|棒球中，雙殺通常代表一次防守行動造成幾個出局？|兩個|一個|三個|四個
sports|hard|鐵人三項的標準項目依序為何？|游泳、自由車、跑步|跑步、游泳、自由車|自由車、跑步、游泳|游泳、跑步、自由車
sports|medium|奧運會五環中，哪個顏色不在五環之中？|紫色|藍色|黃色|綠色
sports|hard|在排球比賽中，一隊通常最多可觸球幾次再把球回擊過網？|三次|兩次|四次|五次
sports|medium|高爾夫球的標準桿數稱為什麼？|Par|Ace|Set|Round
sports|hard|國際象棋中，哪一個棋子可以沿斜線任意格移動？|象|車|馬|兵
sports|medium|馬拉松名稱源自哪個國家的地名？|希臘|義大利|英國|埃及
sports|hard|自由車環法賽的總冠軍通常穿什麼顏色的領騎衫？|黃色|綠色|白色|紅色
sports|medium|棒球投手投出「完美比賽」時，對手全場最多有幾名打者上壘？|零人|一人|三人|九人
sports|hard|拳擊比賽中，裁判讀秒到十通常代表什麼結果？|擊倒出局|換場休息|加賽開始|犯規警告
sports|medium|羽球雙打場地相較單打場地，主要差異是？|雙打場地較寬|雙打場地較短|雙打場地沒有底線|雙打場地沒有發球線
sports|hard|F1 排位賽最重要的直接目標之一是爭取什麼？|較佳發車位置|較多替補車手|最長維修時間|最多安全車圈數
sports|medium|跆拳道比賽主要使用哪種護具保護軀幹？|護胸|護腕|護膝|護頸
sports|hard|棒球中的 ERA 主要用來衡量投手的哪項表現？|平均責失分|平均全壘打|平均盜壘|平均安打距離
sports|medium|足球比賽中，角球從哪個位置開出？|球門兩側的角落弧線|中圈|十二碼點|替補席旁
sports|hard|現代五項通常包含射擊、擊劍、游泳，以及哪兩項？|馬術與跑步|籃球與划船|網球與滑雪|自由車與攀岩
sports|medium|棒球中，盜壘成功需要跑壘員在什麼時機離壘？|投手投球後奔向下一壘|裁判宣布換局前|球飛出界外後|捕手離開本壘後
culture|medium|《蒙娜麗莎》的作者是誰？|李奧納多・達文西|米開朗基羅|拉斐爾|林布蘭
culture|medium|爵士樂最常被認為起源於哪個國家？|美國|巴西|法國|古巴
culture|hard|日本浮世繪藝術家葛飾北齋最著名的作品之一是？|神奈川沖浪裏|睡蓮|最後的晚餐|吶喊
culture|medium|莎士比亞的《羅密歐與茱麗葉》主要以哪座城市為背景？|維洛那|威尼斯|米蘭|佛羅倫斯
culture|hard|古典芭蕾《天鵝湖》的作曲家是誰？|柴可夫斯基|貝多芬|巴哈|舒伯特
culture|medium|義大利料理中的 Risotto 主要是哪一類食物？|燉飯|麵包|湯品|甜點
culture|hard|電影剪接中，將兩個畫面平行交替呈現常用來表達什麼？|同時發生的不同事件|時間完全停止|角色消失|畫面失焦
culture|medium|《小王子》的作者是誰？|聖修伯里|馬克・吐溫|儒勒・凡爾納|安徒生
culture|hard|印象派畫家莫內的《睡蓮》系列主要描繪什麼？|花園池塘景色|城市街道|沙漠風景|海上戰船
culture|medium|日本傳統戲劇「能」的表演特色之一是？|使用面具|完全沒有音樂|只由兒童演出|必須在水中演出
culture|hard|文學中的「反烏托邦」通常描寫哪種社會？|表面完美但高度壓迫的社會|沒有任何規則的原始社會|人人富裕的理想國|只有機器人的社會
culture|medium|哪一種樂器通常有 88 個琴鍵？|鋼琴|小提琴|長笛|豎琴
culture|hard|攝影中的「景深」主要指什麼？|畫面中清晰可接受的距離範圍|鏡頭的重量|照片的檔案大小|快門按鈕的深度
culture|medium|希臘沙拉常見的主要乳酪是哪一種？|菲達乳酪|藍紋乳酪|帕馬森乳酪|馬斯卡彭乳酪
culture|hard|博物館保存紙本文物時，通常要避免哪種環境？|高溫高濕與強光|穩定低溫|避光保存|適度通風
culture|medium|電影中的「配樂」主要扮演什麼功能？|營造情緒與氣氛|取代所有對白|增加畫面亮度|控制觀眾座位
culture|hard|古典建築中的「拱頂」主要利用哪種結構分散重量？|拱形受力|懸吊電纜|液壓支撐|磁力漂浮
culture|medium|法國料理中的 Ratatouille 主要是一道什麼菜？|蔬菜燉菜|海鮮生魚片|奶油蛋糕|烤牛排
culture|hard|「蒙太奇」一詞在電影藝術中通常與哪項技術相關？|剪接組合|現場收音|服裝設計|燈光染色
`;

    additionalQuestionsRaw.trim().split('\n').forEach(line => {
        const [category, difficulty, question, correct, wrong1, wrong2, wrong3] = line.split('|');
        insertQuestion(category, difficulty, question, correct, [wrong1, wrong2, wrong3]);
    });
