(() => {
  ...
  window.SYSTEM_DESIGN_SIM['sd-book-15'] = {
    ...
    briefing: [
      ...
      '**節點上的符號**：✓ 有做保護 · ⚠ 元件照跑但沒備援 · ✕ 這個東西你還沒建（例如還沒建離線備份佇列），流量不會經過它。一般能力節點直接點圓球就能切換；伺服器群組則點上方有底線的策略文字換做法。',
      '**100 人隨機操作模式**：會混合下載變更、通知與檔案上傳，讓你一次觀察伺服器輪詢、不同球色、多封包上傳及資料庫持續累積；可隨時停止。',
