(() => {
  ...
  window.SYSTEM_DESIGN_SIM['sd-book-14'] = {
    ...
    abrSim: {
      ...
      desc: '同一部 1 小時影片被切成 720 個、每個 5 秒的片段，並用加速時間播放。第一段已預先載入，所以前五秒正常播放；同時下載第二段。台灣 CDN 的 720p 片段能在緩衝用完前抵達，美國來源站的同一顆 720p 球因為位元組較大又跨海，會下載超過五秒，播放器先轉圈，再由 ABR 改抓更小、更快的低解析度片段。兩種來源都會直接在上方拓樸圖跑球。',
      segments: 720,
      segmentSec: 5,
      simSecondMs: 50,
      maxBufferSec: 15,
